      ...
      <header className='bg-dark flex justify-between p-4 overflow-hidden rounded-b-3xl items-center'>
        ...
        <div className="">
          <button onClick={()=>{
            ...
            <Image width={40} height={40} src="/vresources/menu.png" alt="" className='w-8' />
          </button>
        </div>
      </header>
      {
        openMenu&&
        <div className="bg-black bg-opacity-70 h-screen absolute top-0 w-screen z-40 text-lowGray">
          <div className="bg-black p-4">
            <div className="flex justify-between items-center ">
              ...
              >
                <Image width={120} height={120} src="/vresources/closeMenu.png" alt="" className='w-10' />
              </button>
            </div>
            <div className="">
